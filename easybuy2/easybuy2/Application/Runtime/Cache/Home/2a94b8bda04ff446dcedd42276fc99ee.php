	...
	<!--/.navbar-->
			   ...
			   <div class="search-box">
					<div id="sb-search" class="sb-search">
						<form action="/SWIM/index.php/home/index/select" method="post">
...
<!-- search-scripts -->
			...
			<div class="container">
				<div class="banner-grids">
					<div class="col-md-6 banner-grid">
						...
						<a href="/SWIM/index.php/home/products" class="button"> 去逛逛 </a>
					</div>
				<div class="col-md-6 banner-grid1">
						<img src="/SWIM/Public/home/images/a1.jpg" class="img-responsive" alt=""/>
				</div>
				<div class="clearfix"></div>
			</div>
		...
		<script src="/SWIM/Public/home/js/owl.carousel.js"></script>
			<script>
		...
		<div id="owl-demo" class="owl-carousel text-center">
			<?php if(is_array($grand)): $i = 0; $__LIST__ = $grand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="item">
				<img class="lazyOwl" data-src="/SWIM/<?php echo ($vo["imageurl"]); ?>" alt="name">
				<div class="item-info">
		...
		<div class="gallery">
			...
			<div class="gallery-grids">
				<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-3 gallery-grid ">
					<a href="/SWIM/index.php/home/goods/index/id/<?php echo ($vo["goodid"]); ?>"><img src="/SWIM/<?php echo ($vo["imageurl"]); ?>" class="img-responsive" alt=""/>
					...
					<div class="galy-info">
						...
						<h5 class="item_price">￥<?php echo ($vo["goodprice"]); ?></h5>
							...
							<div class="shop">
								<div class="btn_form">
									<a href="/SWIM/index.php/home/goods/checkout/goodid/<?php echo ($vo["goodid"]); ?>" class="add-cart item_add">加入购物车</a>
								</div>
