...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/home/admin/index">管理员管理</a><span class="crumb-step">&gt;</span><span>修改管理员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
        <form action="/EASYBUY/index.php/Home/Admin/save" method="post" >
                    <table class="insert-tab" width="100%">
                        <tbody>
                            
                            <tr>
                                <th>原密码：</th>
                                <td><input class="common-text" name="author" size="50" value='<?php echo ($admin["adminpswd"]); ?>' type="text"></td>
                            </tr>
                           <tr>
                                <th>修改密码为：</th>
