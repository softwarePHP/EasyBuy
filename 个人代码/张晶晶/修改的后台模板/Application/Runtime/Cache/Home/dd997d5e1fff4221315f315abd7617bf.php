...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span>用户管理<span class="crumb-step">&gt;</span><span><a href="/index.php/home/user/index">查看用户</a></span><span class="crumb-step">&gt;</span><span><a href="user-view.html">查看</a></span></div>
        </div>
                ...
                <form action="/jscss/admin/design/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <th></th>
                            <td>
                                   <a href="/index.php/home/user/index"><input class="btn btn6" value="返回" type="button"></a>
                                   <a href="/index.php/home/user/update"><input class="btn btn6" value="修改" type="button"></a>
                                </td>
                        </tr>
                        </tbody></table>
                </form>
