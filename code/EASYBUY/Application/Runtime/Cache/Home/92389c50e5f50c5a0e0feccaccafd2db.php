...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">品牌查询</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/EASYBUY/index.php/grands/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/EASYBUY/index.php/home/grands/insert"><i class="icon-font"></i>新增品牌</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($grand)): $i = 0; $__LIST__ = $grand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["grandnum"]); ?></td>
                            <td title="百雀羚"><a target="_blank" href="/EASYBUY/index.php/index/home/goods/show" title="百雀羚"><?php echo ($vo["grandname"]); ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="/EASYBUY/index.php/home/grands/show?id=<?php echo ($vo["grandid"]); ?>">查看</a>
                                <a class="link-update" href="/EASYBUY/index.php/home/grands/revise?id=<?php echo ($vo["grandid"]); ?>">修改</a>
                                <a class="link-del" href="/EASYBUY/index.php/home/grands/delete?id=<?php echo ($vo["grandid"]); ?>">删除</a>
                            </td>
