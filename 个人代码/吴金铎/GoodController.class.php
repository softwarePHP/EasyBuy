...
class GoodController extends Controller
{
    public function index()
    {
        ...
        $goods = M('goods')->order('goodid')->select();//实例化一个商品类
        $i=0;//用于数组date存放数据的角标
    ...
    public function add()
    {
        ...
        if ($result)
        {
            $this->success('商品插入成功','/index.php/home/good/index');
        }
        else
        {
            $this->error('插入失败','index.php/home/good/insert');
        }
    ...
    public function delete()
    {
        ...
        if($result)
        {
            $this->success('删除成功','/index.php/home/good/index');
        }
        else
        {
            $this->error('删除失败','/index.php/home/good/index');
        }
    ...
    public function update()
    {
        ...
        if ($result)
        {
            $this->success('商品修改成功','/index.php/home/good/index');
        }
        else
        {
            $this->error('修改失败','index.php/home/good/revise');
        }
    }
    public function select()
    {
        ...
        $goods = M('goods')->where($condetion)->order('goodid')->select();
        $condetion = NULL;
        $i=0;//用于数组date存放数据的角标
        foreach ($goods as $good)
        {
