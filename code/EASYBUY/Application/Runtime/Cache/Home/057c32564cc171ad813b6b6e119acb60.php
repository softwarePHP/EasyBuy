...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/home/brand/index">品牌管理</a><span class="crumb-step">&gt;</span><span>查看品牌</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY/index.php/home/grands/revise" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th><i class="require-red">*</i>品牌编号：</th>
                            <td>
                                <i class="require-red"><?php echo ($grand["grandnum"]); ?>
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>品牌名称：</th>
                            <td> <?php echo ($grand["grandname"]); ?></td>
                        </tr>
                        <tr>
                            <th>品牌简介：</th>
                            <td>
                                <?php echo ($grand["grandintroduction"]); ?>
                            </td>
                        </tr>
                        <tr>
                            <th></th>
                            <td>
                                <input class="common-text required" id="title" name="goodid" type="hidden" value="<?php echo ($grand["grandid"]); ?>"/>
                                <input class="btn btn6" value="修改" type="submit">
