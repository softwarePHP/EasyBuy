...
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
               ...
               <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="/EASYBUY2/index.php/home/admin/index"><i class="icon-font">&#xe037;</i>查看管理员</a></li>
                    </ul>
                </li>
                <li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY2/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">品牌查询</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/EASYBUY2/index.php/brand/index" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/EASYBUY2/index.php/home/brand/insert"><i class="icon-font"></i>新增品牌</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($grand)): $i = 0; $__LIST__ = $grand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="tc"><input name="id[]" value="59" type="checkbox"></td>

                            <td><?php echo ($vo["grandid"]); ?></td>
                            <td title="百雀羚"><a target="_blank" href="/EASYBUY2/index.php/index/home/good/show" title="百雀羚"><?php echo ($vo["grandname"]); ?></a>
                            </td>
                            <td><textarea name="a" style="width:100%;height:50px;"><?php echo ($vo["grandintroduction"]); ?></textarea></td>
                            <td>
                               <!-- <a class="link-update" href="/home/brand/show">详情</a>-->
                                <a class="link-update" href="/EASYBUY2/index.php/home/brand/insert">添加</a>
                                <a class="link-del" href="/EASYBUY2/index.php/home/Brand/delete?id=<?php echo ($vo["grandid"]); ?>">删除</a>
                            </td>
