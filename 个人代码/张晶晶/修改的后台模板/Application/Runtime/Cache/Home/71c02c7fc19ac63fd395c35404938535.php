            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/home/brand/insert"><i class="icon-font"></i>新增品牌</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>0</td>
                            <td>
                                <a class="link-update" href="/index.php/home/brand/show">详情</a>
                                <a class="link-update" href="/index.php/home/brand/revise">修改</a>
