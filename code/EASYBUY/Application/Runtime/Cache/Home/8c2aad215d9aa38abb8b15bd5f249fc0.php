...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/home/brand/index">品牌管理</a><span class="crumb-step">&gt;</span><span>添加品牌</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY/index.php/home/Brand/insert1" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>品牌ID：</th>
                            <td>
                                <input class="common-text required" id="pinpai" name="grandnum" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>品牌名称：</th>
                            <td>
                                <input class="common-text required" id="title" name="grandname" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th>品牌简介：</th>
                        ...
                        <tr>
                            <th></th>
                                ...
                                <td>
                                    <input class="btn btn-primary btn2" name="sub" value="提交" type="submit">
                                   <a href="/EASYBUY/index.php/home/brand/index"><input class="btn btn6" value="返回" type="button"></a>
                                </td>
