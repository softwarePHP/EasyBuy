    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                <li><a href="/EASYBUY/index.php/home/index/index">欢迎您，<?php echo ($user); ?></a></li>
                <li><a href="/EASYBUY/index.php/home/admin/update">修改密码</a></li>
                <li><a href="/EASYBUY/index.php/home/admin/delete">退出</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="container clearfix">
            ...
            <ul class="sidebar-list">
               ...
               <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="/EASYBUY/index.php/home/brand/index"><i class="icon-font">&#xe017;</i>查看品牌</a></li>
                        <li><a href="/EASYBUY/index.php/home/brand/insert"><i class="icon-font">&#xe017;</i>添加品牌</a></li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span>管理员管理<span class="crumb-step">&gt;</span><span><a href="/index.php/home/admin/index">查看管理员</a></span><span class="crumb-step">&gt;</span><span><a href="/index.php/home/admin/view">查看</a></span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY/index.php/home/admin/index" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <th>密码：</th>
                            <td><?php echo ($admin["adminpswd"]); ?></td>
                        </tr>
                        <tr>
                            <th>权限：</th>
                        ...
                        <tr>
                            <th></th>
                               ...
                               <td>
                                   <a href="/EASYBUY/index.php/home/admin/index"><input class="btn btn6" value="返回" type="button"></a>
                                   <a href="/EASYBUY/index.php/home/admin/update?id=<?php echo ($admin["adminid"]); ?>"><input class="btn btn6" value="修改" type="button"></a>
                                </td>
