    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY/index.php/home/goods/revise?id=<?php echo ($good["goodid"]); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <th>所属品牌</th>
                            <td><?php echo ($good["grandname"]); ?></td>
                        </tr>
                        <tr>
                            <th>所属分类</th>
                            <td><?php echo ($good["categoriesname"]); ?></td>
                        </tr>
                        <tr>
                            <th>第一标签</th>
                            <td><?php echo ($good["mark1"]); ?></td>
                        </tr>
                        <tr>
                            <th>第二标签</th>
                            <td><?php echo ($good["mark2"]); ?></td>
                        </tr>

                        <tr>
                            <th>商品详情</th>
                            <td><?php echo ($good["introduction"]); ?></td>
                        </tr>
                        <tr>
                            <th></th>
                           <td>
                                <a class="link-update" href="/EASYBUY/index.php/home/goods/revise?id=<?php echo ($good["goodid"]); ?>">
                                    <input class="btn btn6" value="修改" type="button">
                                </a>
                                <a class="link-update" href="/EASYBUY/index.php/home/goods/index">
