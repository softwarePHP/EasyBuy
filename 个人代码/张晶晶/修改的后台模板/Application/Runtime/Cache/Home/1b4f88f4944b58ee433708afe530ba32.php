            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/home/type/insert"><i class="icon-font"></i>添加种类</a>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>59</td>
                            <td title="artichoke"><a target="_blank" href="#" title="artichoke">护肤系列</a>
                            <td>
                                <a class="link-update" href="/index.php/home/type/alert">添加</a>
                        ...
                        <tr>
                            ...
                            <td>58</td>
                            <td title="hyacinth"><a target="_blank" href="#" title="hyacinth">彩妆</a>
                            </td>
                            </td>
                            <td>
                                <a class="link-update" href="/index.php/home/type/alert">添加</a>
