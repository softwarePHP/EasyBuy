...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY2/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/home/brand/index">品牌管理</a><span class="crumb-step">&gt;</span><span>添加品牌</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY2/index.php/home/Brand/insert1" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>品牌ID：</th>
                            <td>
                                <input class="common-text required" id="pinpai" name="title" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th></th>
                                ...
                                <td>
                                   ...
                                   <a href="/EASYBUY2/index.php/home/brand/index"><input class="btn btn6" value="返回" type="button"></a>
                                </td>
