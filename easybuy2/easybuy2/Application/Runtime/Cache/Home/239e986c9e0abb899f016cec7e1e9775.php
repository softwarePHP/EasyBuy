	...
	<div class="product-model">
		<div class="container">
			...
			<div class="col-md-9 product-model-sec">
				<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/SWIM/index.php/home/goods/index"><div class="product-grid">
				...
				<div class="product-info simpleCart_shelfItem">
					<div class="product-info-cust prt_name">
						...
						<div class="ofr">
							<!--<p class="pric1"><del>Rs ￥<?php echo ($vo["goodprice"]); ?></del></p>-->
							<!--<p class="disc">[8折]</p>-->
						</div>
						<!--<input type="text" class="item_quantity" value="1" />-->
						<a href = "/SWIM/index.php/home/order/checkout?id=<?php echo ($vo["goodid"]); ?>"><input type="button" class="item_add items" value="+"></a>
						<div class="clearfix"> </div>
					</div>
				</div>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="rsidebar span_1_of_left">
	...
	<div class="row row1 scroll-pane">
		...
		<div class="col col-4">
			<?php if(is_array($categories)): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox"><input type="radio" name="radio" value="<?php echo ($vo["categoriesid"]); ?>"><i></i><?php echo ($vo["categoriesname"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>
	</div>
	</section>
	...
	<section  class="sky-form">
		...
		<div class="row row1 scroll-pane">
			...
			<div class="col col-4">
				<label class="checkbox"><input type="radio" name="price" value="99"><i></i>￥0 - 99</label>
				<label class="checkbox"><input type="radio" name="price" value="199"><i></i>￥99 - 199</label>
				<label class="checkbox"><input type="radio" name="price" value="299" ><i></i>￥199 - 299</label>
				<label class="checkbox"><input type="radio" name="price" value="399"><i></i>￥299 - 399</label>
				<label class="checkbox"><input type="radio" name="price" value="499"><i></i>￥399 - 499</label>
				<label class="checkbox"><input type="radio" name="price" value="599"><i></i>￥499 - 599</label>
				<label class="checkbox"><input type="radio" name="price" value="699"><i></i>￥599 - 699</label>
				<label class="checkbox"><input type="radio" name="price" value="799"><i></i>￥699 - 799</label>
				<label class="checkbox"><input type="radio" name="price" value="899"><i></i>￥799 - 899</label>
				<label class="checkbox"><input type="radio" name="price" value="999"><i></i>￥899 - 999</label>
				<label class="checkbox"><input type="radio" name="price" value="1099"><i></i>￥1000以上</label>
	...
	<!---->
	<!--<script type="text/javascript" src="/SWIM/Public/home/js/jquery-ui.min.js"></script>
	<link rel="stylesheet" type="text/css" href="/SWIM/Public/home/css/jquery-ui.css">
	...
	<section  class="sky-form">
		...
		<div class="row row1 scroll-pane">
			...
			<div class="col col-4">
				<?php if(is_array($grand)): $i = 0; $__LIST__ = $grand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><label class="checkbox"><input type="radio" name="grand" value="<?php echo ($vo["grandid"]); ?>"><i></i><?php echo ($vo["grandname"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
			</div>
		</div>
	</section>
</div>
</div>
	<input type="submit" class="item_add items" value="确定选择">
	</form>
</div>
</div>
<!---->
