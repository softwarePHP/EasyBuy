...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-11-29 01:06:24
-- 服务器版本： 5.7.11
-- PHP Version: 5.6.19
...
(18, '213', 13, 13, 2, 'Public/uploads/20161128/583c3df455d90.jpg', 3, '', '31', '1');
...
(1, 0, '百雀羚', '百雀羚创立于1931年，是国内屈指可数的历史悠久的著名化妆品厂商。悠久的历史，承载着辉煌的业绩，成就了百雀羚品质如金的美誉。品牌连续多次被评为“上海著名商标”，并荣获“中国驰名商标”等称号。传承经典，勇于创新，公司致力于为消费者创造天然温和的优质护肤品，完美演绎“中国传奇，东方之美”。'),
...
(4, 3, '1123153711277', '2016-11-16 00:00:00', 0.8, '西安唐延安路都市世纪城', 2);
...
--
ALTER TABLE `grand`
  MODIFY `grandid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
