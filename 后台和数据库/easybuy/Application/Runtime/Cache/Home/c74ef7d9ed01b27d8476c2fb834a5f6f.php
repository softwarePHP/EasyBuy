...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/EASYBUY2/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span>分类管理<span class="crumb-step">&gt;</span><span><a href="/index.php/home/yonghu/index">添加种类</a></span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY2/index.php/home/Type/insert1" method="post" id="myform" name="categories" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <th><i class="require-red">*</i>添加种类：</th>
                            <td>
                        ...
                        <tr>
                            ...
                            <input class="btn btn-primary btn2" name="sub" value="提交" type="submit">
                                <a class="link-delete" href="/EASYBUY2/index.php/home/type/index">返回</a>
                            </td>
                        </tr>
                        </tbody></table>
    <!--/main-->
