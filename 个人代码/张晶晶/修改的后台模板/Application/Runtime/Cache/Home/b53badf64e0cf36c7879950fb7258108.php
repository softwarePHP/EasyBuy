...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/home/brand/index">品牌管理</a><span class="crumb-step">&gt;</span><span>修改品牌</span></div>
        </div>
            ...
            <div class="result-content">
                <form action="/jscss/admin/design/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>品牌分类：</th>
                            <td>
                                <input class="common-text required" id="pinpai" name="title" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>品牌简介：</th>
                            <td>
                                <input class="common-text required" id="title" name="title" size="50" value="" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>品牌图标：</th>

                            <td><input name="smallimg" id="brand" type="file"><!--<input type="submit" onclick="submitForm('/jscss/admin/design/upload')" value="上传图片"/>--></td>
                        </tr>
                        <tr>
                            <th>品牌详情：</th>
                        ...
                        <tr>
                            <th></th>
                            <td>
                                   <a href="/index.php/home/brand/index"><input class="btn btn6" value="提交" type="button"></a>
                                   <a href="/index.php/home/brand/index"><input class="btn btn6" value="返回" type="button"></a>
                                </td>
                        </tr>
                        </tbody></table>
                </form>
