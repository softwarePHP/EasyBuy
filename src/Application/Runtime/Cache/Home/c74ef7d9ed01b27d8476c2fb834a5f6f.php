...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span>分类管理<span class="crumb-step">&gt;</span><span><a href="/index.php/home/yonghu/index">添加种类</a></span></div>
        </div>
            ...
            <div class="result-content">
                <form action="/jscss/admin/design/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            <th>添加子类：</th>
                            <td><input class="common-text" name="子类" size="50" value="" type="text"></td>
                        </tr>
                        <tr>
                            <th></th>
                             <td>
                                <a class="link-update" href="/index.php/home/type/index">提交</a>
                                <a class="link-delete" href="/index.php/home/type/index">返回</a>
                            </td>
                        </tr>
                        </tbody></table>
    <!--/main-->
