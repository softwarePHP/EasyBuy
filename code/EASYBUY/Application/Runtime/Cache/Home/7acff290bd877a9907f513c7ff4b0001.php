    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/EASYBUY/index.php/home/good/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
                            ...
                            <tr>
                                <th></th>
                                 <td>
                                    ...
                                    <a class="link-update" href="/EASYBUY/index.php/home/good/index"><input class="btn btn6" value="返回" type="button"></a>
                                 </td>
                            </tr>
                        </tbody></table>
                </form>
