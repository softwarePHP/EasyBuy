...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/home/index/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/index.php/home/admin/index">管理员管理</a><span class="crumb-step">&gt;</span><span>修改管理员</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php/Home/Admin/save/adminid{admin.adminid}" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                           ...
                           <tr>
                                <th>修改密码为：</th>
                                <td><input class="common-text" name="author1" size="50" value="admin" type="text"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                   <a href="/index.php/Home/Admin/save/adminid{adminid.adminid}"><input class="btn btn6" value="提交" type="button"></a>
                                   <a href="/index.php/home/admin/index"><input class="btn btn6" value="返回" type="button"></a>
                                </td>
                            </tr>
                        </tbody></table>
                </form>
