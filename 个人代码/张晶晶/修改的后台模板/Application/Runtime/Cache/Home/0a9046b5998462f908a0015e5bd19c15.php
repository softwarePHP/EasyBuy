...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index.php/index/index">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">订单管理</span><span class="crumb-step">&gt;</span><span class="crumb-name">未处理订单</span></div>
        </div>
            ...
            <div class="search-content">
                <form action="/jscss/admin/design/index" method="post">
                    <table class="search-tab">
                        <tr>
                            <th width="70">订单号:</th>
                            <td><input class="common-text" placeholder="请输入需要查询的订单号" name="keywords" value=""  type="text"></td>
                            <th width="70">收货人:</th>
                            <td><input class="common-text" placeholder="请输入需要查询的收货人" name="keywords" value=""  type="text"></td>
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href="#">交易完成</a>
                            </td>
                        </tr>
                        <tr>
