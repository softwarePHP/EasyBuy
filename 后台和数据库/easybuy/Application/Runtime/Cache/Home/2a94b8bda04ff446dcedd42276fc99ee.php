...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font">&#xe06b;</i><span>欢迎使用『』后台</span></div>
        </div>
        <div class="result-wrap">
            ...
            <div class="result-content">
                <div class="short-wrap">
                    <a href="shangpin-insert.html"><i class="icon-font">&#xe001;</i>新增商品</a>
                    <a href="type-insert.html"><i class="icon-font">&#xe005;</i>新增种类</a>
                    <a href="pinpai-insert.html"><i class="icon-font">&#xe048;</i>新增品牌</a>
                    <a href="admin-insert.html"><i class="icon-font">&#xe041;</i>新增管理员</a>
                    <a href="dingdan-untreated.html"><i class="icon-font">&#xe01e;</i>订单处理</a>
                </div>
            </div>
        </div>
        <div class="result-wrap">
